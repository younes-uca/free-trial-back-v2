...
public class DateUtil {
    ...
    */
    ...
    public static boolean compareByYearMonthAndDay(LocalDateTime date1, LocalDateTime date2) {
        return date1.getYear() == date2.getYear() && date1.getMonth() == date2.getMonth() && date1.getDayOfWeek() == date2.getDayOfWeek();
    }

    public static boolean compareByYearMonthAndDay(LocalDateTime date1) {
        return compareByYearMonthAndDay(date1, today);
    }
}
